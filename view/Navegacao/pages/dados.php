    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <h1 class="page-header">Seus dados</h1>
                                <div class="form-group">
                                    <label for="disabledSelect">Nome</label>
                                    <input class="form-control" id="disabledInput" type="text" placeholder=" <?php echo ($dado["nome"]);?>" disabled>
                                 </div>
                                 <div class="form-group">
                                    <label for="disabledSelect">E-mail</label>
                                    <input class="form-control" id="disabledInput" type="text" placeholder=" <?php echo ($dado["email"]);?>" disabled>
                                 </div>
                                 <div class="form-group">
                                    <label for="disabledSelect">Telefone</label>
                                    <input class="form-control" id="disabledInput" type="number" placeholder=" <?php echo ($dado["telefone"]);?>" disabled>
                                 </div>
                                 <div class="form-group">
                                    <label for="disabledSelect">Ramo de negócio</label>
                                    <input class="form-control" id="disabledInput" type="text" placeholder=" <?php echo ($dado["ramo"]);?>" disabled>
                                 </div>
